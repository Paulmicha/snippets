...
#   wget https://github.com/Paulmicha/snippets/raw/master/Sys-admin/Drupal/7/phpfpm-fixperms.script.sh --quiet --no-check-certificate -O ~/custom_bash_scripts/d7_phpfpm_fixperms.sh
